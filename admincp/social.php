...
<div class="page-header page-header-light">
	<div class="page-header-content header-elements-md-inline">
		<div class="page-title d-flex">
			<h4><i class="icon-facebook mr-2"></i> <span class="font-weight-semibold"><?php _e( $_TITLE ); ?></span></h4>
		</div>
	</div>
...
<div class="content">
	...
	<?php
	$option_query = mysql_query("SELECT * FROM `social` WHERE `meta`!='hide'");
	...
	<div id="add-new-card" class="card">
		<div class="card-body">
			...
			<form action="mini_process.php" method="post" enctype="multipart/form-data">
				...
				<input type="hidden" name="p" value="UpdSocial">
